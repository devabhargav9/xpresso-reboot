    ...
    <div className="border-b border-slate-200 bg-white">
      <div className="hidden border-b border-slate-100 bg-slate-50 px-6 py-1.5 text-[11px] text-slate-500 sm:flex sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          ...
          <span className="inline-flex items-center gap-1">
            <Mail className="h-3 w-3" /> admissions@srisai.ac.in
          </span>
          <span className="inline-flex items-center gap-1">
            <MapPin className="h-3 w-3" /> Rayachoti, Andhra Pradesh
          </span>
        </div>
...
function Disclosures() {
  const items = [
    ...
    {
      title: "NIRF 2026",
      detail: "Engineering: Rank 87 (national) · Andhra Pradesh top 12",
  ...
  const items = [
    {
      kind: "Paper",
      title:
        "Federated Learning for On-Device Privacy: An Andhra Pradesh Telemedicine Pilot",
    ...
    },
    {
      kind: "Grant",
      title:
        "DST-SERB grant: AI-assisted maintenance for Andhra Pradesh grid infrastructure",
    ...
    <div className="border-t border-slate-200 bg-slate-900 text-slate-200">
      <div className="px-6 py-12">
        <div className="grid gap-8 lg:grid-cols-[1.2fr_2fr_1fr]">
          <div className="flex flex-col gap-3">
            ...
            <p className="text-[12px] leading-relaxed text-slate-400">
              Rayachoti 516269 · Andhra Pradesh, India
            </p>
            <p className="text-[12px] leading-relaxed text-slate-400">
              +91 80 4123 4567 · admissions@srisai.ac.in
            </p>
            <div className="mt-2 flex flex-wrap items-center gap-2">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-between gap-2 border-t border-slate-700 pt-6 text-[10.5px] text-slate-500">
          <span>© 2026 Sri Sai Institute of Technology and Science. All rights reserved.</span>
